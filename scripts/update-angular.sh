...
function run {
  ...
  wget https://code.angularjs.org/$VERSION/angular{,-sanitize,-cookies,-animate,-resource,-aria,-messages}{.min.js,.js}
  ...
  replaceJsonProp "bower.json" "angular-cookies" "$VERSION"
